...
const dbUrl = 'mongodb+srv://Amine:nunka@freecluster-jomdc.mongodb.net/Podcast?retryWrites=true&w=majority';
...
app.get('/amy-whinhouse-under', (req, res) => {
    res.render('amy-whinhouse-under.ejs')
})
app.get('/at-the-bbc', (req, res) => {
    res.render('at-the-bbc.ejs')
})
app.get('/back-to-black', (req, res) => {
    res.render('back-to-black.ejs')
})
...
// @route POST ARTIST
app.use('/createArtist', require('./src/Routes/Artists/create_Artist.js'));
// route PUT ARTIST
